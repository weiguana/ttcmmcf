...
ttcmmcf.collections.onCreated(function() {
     ...
     */
    ttcmmcf.authc.addProtectedRoute('collections.' + self.name + '.index');
     ...
     * Ensure user is logged in
     */
    ttcmmcf.authc.addProtectedRoute('collections.' + self.name + '.create');
     ...
     * Ensure user is logged in
     */
    ttcmmcf.authc.addProtectedRoute('collections.' + self.name + '.update');
     ...
     * Ensure user is logged in
     */
    ttcmmcf.authc.addProtectedRoute('collections.' + self.name + '.delete');
});
